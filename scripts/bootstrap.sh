...
echo -e "    k3s-server      (192.168.1.30) — control-plane"
echo -e "    k3s-worker-cicd (192.168.1.31) — worker cicd"
echo -e "    ci-runner       (192.168.1.32) — worker runner"
echo -e "    notebook-i5     (192.168.1.65) — worker monitoring (bare metal)"
echo -e "    raspberry-pi    (192.168.1.110) — worker edge (bare metal, arm)"
echo ""
